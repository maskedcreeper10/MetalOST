...
- **New dialogue**: Uncover new dialogue, most of which is from ~~steel~~ metal soul mode.

## Credits
- **Maskedcreeper10**: Mod programmer.

- **RYS**: Composer and rights holder of the metal tracks used in the mod with permission. Find more of his work at: https://rysmusic.bandcamp.com

- **SFGrenade**: The mod uses portions of code from **CustomBGM** made by SFGrenade. 
Their code is licensed under the European Union Public Licence v1.2.
You can find the original project at: https://github.com/SFGrenade/CustomBgm.
See the `LICENSE` file for more info.

- **GrukDaCaveman**: Writer of poetry found throughout the mod.

### Special thanks to:

- All of the people in the HK modding discord, which have helped with a lot of coding problems.

- All of the people in the RYS discord, which have helped a lot with design choices.

- And of course **Team Cherry** for making Hollow Knight. (Also... Silksong when?)
